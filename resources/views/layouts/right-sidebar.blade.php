...
<div id="right_sidebar" class="right_bar">
    <div class="rightbar-wrapper">
        ...
        <div class="rightbar-header">
            <img src="{{ asset('img/demo/img1.jpg') }}" class="rounded-circle user" alt=""/>
        ...
        <div class="card friend-list">
            ...
            <div class="card-block collapse show" id="friends">
                ...
                <div id="friends">
                    <div class="friend">
                        <img src="{{ asset('img/demo/img1.jpg') }}" />
                        <div class="detail">
                    ...
                    <div class="friend">
                        <img src="{{ asset('img/demo/img2.jpg') }}" />
                        <div class="detail">
                    ...
                    <div class="friend">
                        <img src="{{ asset('img/demo/img3.jpg') }}" />
                        <div class="detail">
                    ...
                    <div class="friend">
                        <img src="{{ asset('img/demo/img4.jpg') }}" />
                        <div class="detail">
                    ...
                    <li class="feed-item" data-content="&#xeb35">
                        <section>
                            ...
                            <main class="content">
                                ...
                                <img src="{{ asset('img/demo/img3.jpg') }}" alt="image" class="rounded-circle img-20 m-t-10 m-r-10"/>
                                <img src="{{ asset('img/demo/img4.jpg') }}" alt="image" class="rounded-circle img-20 m-t-10"/>
                            </main>
                        </section>
                    </li>
                    ...
                    <li class="feed-item" data-content="&#xeb35">
                        <section>
                            ...
                            <main class="content">
                                ...
                                <img src="{{ asset('img/demo/img1.jpg') }}" alt="image" class="rounded-circle img-20 m-t-10 m-r-10"/>
                            </main>
                        </section>
                    </li>
    ...
    <div id="conversation">
        ...
        <div class='chat-wrapper'>
            <div class='chat-message chat-message-recipient'>
                <img class='chat-image' src="{{ asset('img/demo/img1.jpg') }}" />
            ...
            <div class='chat-message chat-message-sender'>
                <img class='chat-image' src="{{ asset('img/demo/img2.jpg') }}" />
                <div class='chat-message-wrapper'>
                    <div class='chat-message-content'>
                        <p>Pizza?</p>
