    ...
    <div class="header">
        <div class="header-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Create new entry</li>
            </ul>
        </div>
    </div>
    <!-- /Page header -->
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                <form action="{{route('pricing.store')}}" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" id="crop" name="crop" autofocus value="{{old('crop')}}">
                                            @if ($errors->has('crop'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="number" class="form-control" id="space_requirement_1" name="space_requirement_1" required value="{{old('space_requirement_1')}}">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="number" class="form-control" id="space_requirement_2" name="space_requirement_2" required value="{{old('space_requirement_2')}}">
