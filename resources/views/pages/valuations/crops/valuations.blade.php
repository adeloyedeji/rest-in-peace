...
@section('title')
  | Crops/Economic Trees Valuation
@endsection
    ...
    <div class="header">
        <div class="header-content">
            <div class="page-title">
                <i class="icon-lifebuoy position-left"></i> Crops/Economic Trees Valuations
            </div>
            <ul class="breadcrumb">
                <li><a href="{{ route('home') }}"></a></li>
                <li class="active">Crops/Economic Trees Valuations</li>
            </ul>
        </div>
    </div>
    <!-- /Page header -->
                    ...
                    <div class="card-block no-pl no-pr">
                        <table class="table table-striped table-borderless">
                            <tbody>
                                ...
                                {{-- <tr>
                                    <td class="text-right">
                                        <span class="text-semibold">Pending beneficiaries</span>
                                    </td>
                                    <td>200</td>
                                </tr> --}}
                            </tbody>
