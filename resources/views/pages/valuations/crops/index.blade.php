...
@section('title')
  | Crops/Economic Trees Valuation Summary
@endsection
    ...
    <div class="header">
        <div class="header-content">
            <div class="page-title">
                <i class="icon-briefcase position-left"></i> Crops/Economic Trees Valuations Summary
            </div>
            <ul class="breadcrumb">
    ...
    <div class="container-fluid page-content">
        ...
        <div class="card card-inverse card-flat">
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-center">Crops/Economic Trees Valuations</h4>
