            ...
            <div class="col-md-9">
				...
				<div class="card card-inverse">
                    <div class="card-header">
                        <div class="card-title">Beneficiary Structures Property Enrollment Form</div>
                    </div>
                    ...
                    <div class="form-basics" style="padding:40px;">
                        @include('pages.properties.forms.structures.partials.prelim')
                    </div>
                </div>
                <!-- /Basic form steps wizard -->
            </div>
